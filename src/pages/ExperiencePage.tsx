  ...
  return (
    <div className="w-full bg-surface min-h-screen text-on-surface">
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="absolute top-80 left-10 w-80 h-80 bg-emerald-100/40 rounded-full blur-3xl pointer-events-none -z-10" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="flex flex-col gap-3 max-w-4xl">
            <div className="inline-flex items-center gap-2 self-start px-3 py-1 bg-blue-50 border border-blue-200 rounded-lg text-blue-600 font-bold">
              <span className="material-symbols-outlined text-base">account_tree</span>
              <span className="font-mono text-xs uppercase tracking-wider">
                CAREER TRAJECTORY & EXECUTIVE LEADERSHIP
              </span>
            </div>
            <h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl text-slate-900 tracking-tight font-extrabold">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
            <div className="relative p-5 bg-white rounded-xl shadow-sm border border-slate-200 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md group">
              <div className="flex items-center justify-between mb-2">
                <span className="font-mono text-xs text-slate-400 uppercase tracking-wider font-bold">Experience</span>
              ...
              <div className="font-heading text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight leading-none mb-1">10+ Years</div>
              <div className="text-xs text-slate-600 font-medium">Enterprise Delivery Leadership</div>
              <div className="mt-3 pt-2 flex items-center gap-1 text-emerald-700 text-xs font-mono font-bold border-t border-slate-100">
            ...
            <div className="relative p-5 bg-white rounded-xl shadow-sm border border-slate-200 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md group">
              <div className="flex items-center justify-between mb-2">
                <span className="font-mono text-xs text-slate-400 uppercase tracking-wider font-bold">Volume</span>
                <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                  <span className="material-symbols-outlined text-lg">account_balance_wallet</span>
                </div>
              </div>
              <div className="font-heading text-2xl sm:text-3xl font-extrabold text-blue-600 tracking-tight leading-none mb-1">$40M+</div>
              <div className="text-xs text-slate-600 font-medium">Cumulative Project Delivery Volume</div>
              <div className="mt-3 pt-2 flex items-center gap-1 text-slate-500 text-xs font-mono font-medium border-t border-slate-100">
            ...
            <div className="relative p-5 bg-white rounded-xl shadow-sm border border-slate-200 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md group">
              <div className="flex items-center justify-between mb-2">
                <span className="font-mono text-xs text-slate-400 uppercase tracking-wider font-bold">Entities</span>
                <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                  <span className="material-symbols-outlined text-lg">corporate_fare</span>
                </div>
              </div>
              <div className="font-heading text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight leading-none mb-1">40+</div>
              <div className="text-xs text-slate-600 font-medium">Gov & Tier-1 Entities Transformed</div>
              <div className="mt-3 pt-2 flex items-center gap-1 text-emerald-700 text-xs font-mono font-bold border-t border-slate-100">
            ...
            <div className="relative p-5 bg-white rounded-xl shadow-sm border border-slate-200 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md group">
              <div className="flex items-center justify-between mb-2">
                <span className="font-mono text-xs text-slate-400 uppercase tracking-wider font-bold">Governance</span>
              ...
              <div className="font-heading text-2xl sm:text-3xl font-extrabold text-emerald-600 tracking-tight leading-none mb-1">100%</div>
              <div className="text-xs text-slate-600 font-medium">On-Time Milestone Governance</div>
              <div className="mt-3 pt-2 flex items-center gap-1 text-slate-500 text-xs font-mono font-medium border-t border-slate-100">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-12 pb-4 border-b border-slate-200">
            ...
            <button
              type="button"
              onClick={toggleAll}
              className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-slate-100 text-slate-800 text-xs font-bold rounded-lg hover:bg-slate-200 transition-all self-start sm:self-auto cursor-pointer border border-slate-200"
            >
          ...
          <div ref={containerRef} className="relative mt-8 space-y-8">
            ...
            <div className="absolute left-4 sm:left-8 top-6 bottom-8 w-[2px] bg-slate-200 -translate-x-1/2" />
            ...
            {experiences.map((exp) => {
              ...
              return (
                <div key={exp.id} className="relative pl-12 sm:pl-20">
                  ...
                  <div className="absolute left-4 sm:left-8 top-6 -translate-x-1/2 w-8 h-8 rounded-full bg-white flex items-center justify-center shadow-md z-10 border border-slate-300">
                  ...
                  {/* Timeline Card */}
                  <div className="bg-white rounded-xl p-5 sm:p-7 shadow-sm border border-slate-200 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4 pb-4">
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="flex flex-wrap items-baseline gap-2 mt-1">
                          <h2 className="font-heading text-xl sm:text-2xl text-slate-900 font-extrabold">
                            {exp.role}
                          </h2>
                        ...
                        {/* Tenure & Location */}
                        <div className="flex flex-wrap items-center gap-3 text-slate-600 text-xs mt-1">
                          <div className="flex items-center gap-1">
                            <span className="material-symbols-outlined text-sm text-slate-400">calendar_today</span>
                            <span className="font-mono font-bold text-slate-800">{exp.tenure}</span>
                          </div>
                      ...
                      {exp.dealMetric ? (
                        <div className="p-2.5 px-4 bg-blue-50 rounded-lg self-start text-right hidden sm:block border border-blue-200">
                          <div className="font-mono text-[10px] text-blue-800 uppercase tracking-wider font-bold">{exp.dealMetric.label}</div>
                          <div className="font-heading text-base font-extrabold text-blue-700">{exp.dealMetric.value}</div>
                        </div>
                      ) : exp.statusBadge.isCurrent ? (
                        <div className="hidden sm:flex items-center gap-2 p-2 px-3 bg-slate-50 rounded-lg self-start border border-slate-200">
                          ...
                          <div className="flex flex-col">
                            ...
                            <span className="font-mono text-[11px] text-slate-900 font-bold">Oceania • MEA</span>
                          </div>
                        </div>
                      ) : null}
                    </div>
                    ...
                    <div className="flex flex-wrap gap-1.5 my-4">
                      {exp.impactBadges.map((badge, bIdx) => (
                        <span key={bIdx} className="font-mono text-[11px] px-2.5 py-1 bg-slate-100 text-slate-800 rounded font-bold border border-slate-200">
                          {badge}
                        </span>
                      ))}
                    </div>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between p-3 px-4 bg-slate-50 rounded-lg text-slate-900 hover:bg-slate-100 transition-colors cursor-pointer text-left border border-slate-200"
                    >
                    ...
                    <AnimatePresence initial={false}>
                      {isExpanded && (
                        ...
                        >
                          <div className="mt-3 p-4 bg-white rounded-lg flex flex-col gap-2.5 border border-slate-200 shadow-inner">
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 mt-4 pt-3 border-t border-slate-100">
                      ...
                      {exp.techStack.map((tech, tIdx) => (
                        <span key={tIdx} className="font-mono text-[11px] px-2 py-0.5 bg-slate-100 text-slate-700 rounded border border-slate-200 font-semibold">
                          {tech}
                        </span>
                      ))}
                    </div>
          ...
          <div className="mt-16 text-center space-y-4 pt-8 border-t border-slate-200">
